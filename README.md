...
**ANYBODY is welcome to collaborate with us! Await new updates!**
# Slither.io bot
Just for fun and AI. Written in Python, this is a project which the aim is to make a computer play against humans inside a human-driven game, which is in this case Slither.io. The goal is simple - try and make the snake score higher as much as possible.
...
# MimiNake: A super clever slither.io robot using Evolutionary Neuro Network
